...
class RectangularRoom(object):
    ...
    def getNumTiles(self):
        ...
        returns: an integer
        """
        return (len(self.dirty_tiles) + len(self.clean_tiles))
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    for i in range(num_trials):
        ...
        steps_needed += counter
        
    return steps_needed/num_trials
...
print(runSimulation(2, 1.0, 10, 10, 0.75, 10, RandomWalkRobot))
...
#     plot.
# showPlot1('plot1', 'number of robots', 'steps needed')
